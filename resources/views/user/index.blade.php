                                        ...
                                        <form action="{{ route('books.borrow', $book->id) }}" method="POST">
                                            ...
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control" id="quantity{{ $book->id }}" name="count" min="1" max="{{ $book->count }}" required>
                                                    <small class="form-text text-muted">Available: {{ $book->count }}</small>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="days{{ $book->id }}" class="form-label">Borrow Days</label>
                                                    <input type="number" class="form-control" id="days{{ $book->id }}" name="borrow_days" min="1" max="30" required>
